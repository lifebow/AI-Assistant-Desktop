            ...
            <div className="flex items-center justify-between px-5 py-3 bg-white dark:bg-gpt-sidebar border-b border-slate-200 dark:border-gpt-hover shrink-0 z-20 relative">
                <div className="flex items-center gap-3 flex-1 min-w-0">
                    ...
                    <div className="relative flex-1 min-w-0" ref={modelMenuRef}>
                        ...
                        {isModelMenuOpen && (
                            <div className="absolute top-full left-0 w-[260px] max-h-[400px] overflow-y-auto bg-white dark:bg-gpt-sidebar border border-slate-200 dark:border-gpt-hover rounded-xl shadow-xl z-50 mt-2 custom-scrollbar flex flex-col">
